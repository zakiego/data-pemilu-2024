    ...
    get_detail_tps: async (id: string) => {
      ...
      const schema = z.object({
        ...
        administrasi: z
          .object({
            suara_sah: z.number(),
            suara_total: z.number(),
            pemilih_dpt_j: z.number(),
            pemilih_dpt_l: z.number(),
            pemilih_dpt_p: z.number(),
            pengguna_dpt_j: z.number(),
            pengguna_dpt_l: z.number(),
            pengguna_dpt_p: z.number(),
            pengguna_dptb_j: z.number(),
            pengguna_dptb_l: z.number(),
            pengguna_dptb_p: z.number(),
            suara_tidak_sah: z.number(),
            pengguna_total_j: z.number(),
            pengguna_total_l: z.number(),
            pengguna_total_p: z.number(),
            pengguna_non_dpt_j: z.number(),
            pengguna_non_dpt_l: z.number(),
            pengguna_non_dpt_p: z.number(),
          })
          .nullable(),
        psu: z.null(),
        ts: z.string(),
